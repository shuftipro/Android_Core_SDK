package com.example.shuftiproautocapture.activities;
...
import com.example.shuftiproautocapture.Helpers;
import com.example.shuftiproautocapture.R;
        ...
        if(requestObj!=null)
        {
            shuftipro.shuftiproVerification(requestObj,AuthKeys, Config,HomeActivity.this, new ShuftiVerifyListener() {
                ...
                public void verificationStatus(HashMap<String, String> responseSet) {
                    ...
                    Toast.makeText(HomeActivity.this, responseSet.toString(), Toast.LENGTH_SHORT).show();
